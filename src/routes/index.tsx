    ...
    <main className="relative min-h-screen overflow-hidden">
      <section className="relative mx-auto flex min-h-screen max-w-6xl flex-col items-center justify-center px-6 text-center">
        ...
        <h1
          ...
          style={{ animation: "ws-clarify 1s cubic-bezier(0.2,0.7,0.2,1) 1.4s both" }}
        >
          Where startups get{" "}
        ...
        <p
          ...
          style={{ animation: "ws-clarify-sub 0.8s ease-out 2s both" }}
        >
        ...
        <div
          ...
          style={{ animation: "ws-fade-up 0.6s ease-out 2.6s both" }}
        >
          <a
            href="#apply"
